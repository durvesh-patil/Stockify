...
const Expenses = () => {
  ...
  const classNames = {
    ...
    input:
      "w-full border border-gray-200 rounded-lg p-2 focus:outline-none focus:border-blue-500",
    select:
    ...
    <div>
      ...
      <div className="mb-5">
        ...
        <p className="text-sm text-gray-500 ">
          A visual representation of your expenses overtime
        </p>
      </div>
      {/*FILTERS */}
      <div className="flex flex-col md:flex-row justify-between gap-4">
        <div className="w-full md:w-1/3 bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            {/*CATEGORY */}
            <div>
              <label htmlFor="category" className={classNames.label}></label>
              <select
                id="category"
                name="category"
